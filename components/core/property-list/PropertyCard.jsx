...
const PropertyCard = ({property}) => {
  return (
    <div className='bg-white shadow-1 p-5 rounded-lg w-full max-w-[352px] mx-auto cursor-pointer hover:shadow-2xl transition'>
      <Image width={property.image.width} height={property.image.height} className='mb-8 rounded-lg' src={property.image.src} alt='' />
      ...
      <div className='text-lg font-semibold max-w-[260px]'>{property.address}</div>
